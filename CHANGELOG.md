...
- Advance AUDILINK to released LINK 0.15.62 at `0f2cc710fb8f211013cd5f55df390fe0911886da`, consuming the canonical nested Infiltratr Common 1.19.24 pin and the guarded STM32 UDS RX fallback.
- Requalify the existing manufacturer-specific product surface against the current shared LINK/Common dependency chain without broadening diagnostic permissions or inventing manufacturer behaviour.

## 0.2.26 — 2026-09-22

- Advance AUDILINK to LINK 0.15.55 at 0caaf4026dcf, retaining the Infiltratr Common 1.19.23 pin and corrected dependency metadata.

## 0.2.25 — 2026-09-22

- Advance AUDILINK to the canonical LINK 0.15.54 release at 38826aa2dca7, which pins Infiltratr Common 1.19.23, and synchronise Apple embedded-LINK provenance with the exact gitlink.

## 0.2.24 — 2026-09-22

- Advance AUDILINK to LINK 0.15.51, which pins Infiltratr Common 1.19.22, and synchronise the Apple embedded-LINK provenance with the exact gitlink.
...
This file records user-visible, compatibility, architecture and validation changes for AUDILINK.
