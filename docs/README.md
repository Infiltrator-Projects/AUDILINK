...
This directory is the canonical documentation entry point for AUDILINK. The Infiltrator project family uses the same baseline document roles in every repository so readers can move between projects without relearning the structure.
...
- docs/GENERIC_BASELINE.md — specialist or historical detail retained alongside the canonical baseline.
- docs/OBD2.md — specialist or historical detail retained alongside the canonical baseline.
